...
c.sendQuest("DeltaScape Highscores", 6399);
c.sendQuest("Cleaned Delta v1", 640);
c.sendQuest("Quests (cleaned)", 663);


c.sendFrame126("Delta Cleaned v1 - Deposit Box", 7421);

c.sendQuest("The Bank of Delta cleaned v1",5383);
...
c.sendQuest("Visit the land of Monkeys", 7458);
    ...
    c.sendQuest("Pking@red@/@whi@Main Towns", 1325);
    c.sendQuest("Go pking or 2 main towns", 1326);
    c.sendQuest("Pking@red@/@whi@Main Towns", 13047);
    c.sendQuest("Go pking or 2 main towns", 13048);
    c.sendQuest("@gre@0/0", 13051);
    c.sendQuest("@gre@0/0", 13052);
    c.sendQuest("Camelot", 1350);
    c.sendQuest("Visit the seers and pick flax", 1351);
    ...
    c.sendFrame126("", 6664);
		...
		c.sendQuest("5: DeltaScape staff impersonation", 5975);
